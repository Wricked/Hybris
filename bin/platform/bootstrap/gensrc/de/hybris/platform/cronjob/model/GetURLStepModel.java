...
/**
 * Generated model class for type GetURLStep first defined at extension processing.
 */
@SuppressWarnings("all")
public class GetURLStepModel extends MediaProcessorStepModel
{
	/**<i>Generated model type code constant.</i>*/
	public final static String _TYPECODE = "GetURLStep";
	 ...
	 */
	public GetURLStepModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public GetURLStepModel(final BatchJobModel _batchJob, final String _code, final Integer _sequenceNumber)
	{
		super();
	 ...
	 */
	@Deprecated
	public GetURLStepModel(final BatchJobModel _batchJob, final String _code, final ItemModel _owner, final Integer _sequenceNumber)
	{
		super();
		setBatchJob(_batchJob);
		setCode(_code);
