...
public class AdvancePaymentInfoModel extends PaymentInfoModel
{
	...
	public final static String _TYPECODE = "AdvancePaymentInfo";
	 ...
	 */
	public AdvancePaymentInfoModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public AdvancePaymentInfoModel(final String _code, final UserModel _user)
	{
		super();
		setCode(_code);
		setUser(_user);
	 ...
	 */
	@Deprecated
	public AdvancePaymentInfoModel(final String _code, final ItemModel _original, final ItemModel _owner, final UserModel _user)
	{
		super();
		setCode(_code);
