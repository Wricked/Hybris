...
public class ConfigProxyMetaTypeModel extends ComposedTypeModel
{
	...
	public final static String _TYPECODE = "ConfigProxyMetaType";
	 ...
	 */
	public ConfigProxyMetaTypeModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public ConfigProxyMetaTypeModel(final Boolean _catalogItemType, final String _code, final Boolean _generate, final Boolean _singleton, final ComposedTypeModel _superType)
	{
		super();
	 ...
	 */
	@Deprecated
	public ConfigProxyMetaTypeModel(final Boolean _catalogItemType, final String _code, final Boolean _generate, final ItemModel _owner, final Boolean _singleton, final ComposedTypeModel _superType)
	{
		super();
		setCatalogItemType(_catalogItemType);
		setCode(_code);
